...
train_tfrecords_dir = os.path.join(SCRIPT_PATH, '../data/train-tfrecords-output')
test_tfrecords_dir = os.path.join(SCRIPT_PATH, '../data/test-tfrecords-output')
...
def load_examples(args):
    total_records = 0
    if args.input_dir:
        train_tfrecords_dir = args.input_dir
    if args.mode == "test":
