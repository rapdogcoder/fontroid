...
DEFAULT_LABEL_FILE = os.path.join(SCRIPT_PATH,
                                  '../../data/labels/256-common-hangul.txt')
DEFAULT_TARGET_FONTS_DIR = os.path.join(SCRIPT_PATH, '../../data/trg_font')
DEFAULT_SOURCE_FONTS_DIR = os.path.join(SCRIPT_PATH, '../../data/src_font')
DEFAULT_OUTPUT_DIR = os.path.join(SCRIPT_PATH, '../../data/src-image-data')
