...
file_cur = os.path.dirname(os.path.dirname(__file__))
...
os.system(f'fontforge -lang=py -script {os.path.join(file_cur,"tools/svgs2ttf.py")} {os.path.join(output_dir,"2350.json")}')